...
const Login = () => {
  ...
  return (
    <div className="container Login p-4 body-login">
      <div>
        <div className=" shadow px-5 py-4 rounded body-secondary-body" >
      ...
      <div className="d-flex align-items-center mobile-center"><div className="image-style-login"></div></div>
    </div>
  );
};
