    ...
    <div className="py-5 col-lg-12 col-md-12 col-sm-12">
      ...
      <div className="col-lg-12 col-md-12 col-sm-12 container-categories">
        ...
        <div className=" gap-2 d-flex justify-content-center pb-5 ">
            <button className="size-category">   <div className=""><i className="fa-solid fa-spray-can-sparkles fs-3"> </i></div>
            <div className="pt-2 ">Limpieza</div></button>
            
            <button className="size-category">   <div className=""><i className="fa-solid fa-screwdriver-wrench fs-3"></i></div>
            <div className="pt-2 ">Plomero</div></button>
            
            <button className="size-category">   <div className=""><i className="fa-solid fa-leaf fs-3"></i></div>
            <div className="pt-2 ">Jardinería</div></button>

            <button className="size-category">   <div className=""><i className="fa-solid fa-person-digging fs-3"></i></div>
            <div className="pt-2 ">Albañilería</div></button>

            <button className="size-category">   <div className=""><i className="fa-solid fa-bolt fs-3"></i></div>
            <div className="pt-2 ">Servicio Eléctrico</div></button>

            <button className="size-category">   <div className=""><i className="fa-solid fa-helmet-safety fs-3"></i></div>
